...
import AutoScrollWrapper from "../utils/AutoScrollWrapper.jsx";
  ...
  const repartoConfig = {
    ...
    elettrico: {
      ...
      accoppiamentoStati: {
        ...
        "bm in preparazione": ["E: Materiale BM in preparazione","E: Materiale BM quasi completo"],
        "bm pronto": ["Materiale BM Completo","E: Materiale impegnato da gestionale da ufficio acquisti"],
        completate: [
          "E: Completate",
    ...
    <div className="filters-burger">
      ...
      <div className={`main-container ${isBurgerMenuOpen ? "shifted" : ""}`}>
        <DndProvider backend={HTML5Backend}>
          <AutoScrollWrapper scrollContainerRef={scrollContainerRef} isDragging={isDragging}  threshold={300}>
