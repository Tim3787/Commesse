...
function App() {
  ...
  const routes = [
    ...
    {
      path: '/visualizzazione-commesse-Produzione',
      component: <VisualizzazioneCommesseProduzione />,
    },
    ...
    {
      path: '/Assegna-Machina-Componenti',
      component: <AssegnazioneMacchinaComponenti />,
      requiredRole: 2,
    },
    {
      path: '/VisualizzaTutteLeAttivita',
      component: <VisualizzaTutteLeAttivita />,
      requiredRole: 2,
    },
        ...
        <Routes>
          ...
          {routes.map(({ path, component, requiredRole }) => (
            <Route
              key={path}
              path={path}
              element={<ProtectedRoute requiredRole={requiredRole}>{component}</ProtectedRoute>}
            />
          ))}
        </Routes>
      </div>
