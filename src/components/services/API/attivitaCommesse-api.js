...
export const fetchRepartoOpenActivities = async (repartoId, token) => {
  const response = await apiClient.get(`/api/attivita_commessa/reparto/${repartoId}/aperte`, {
    headers: { Authorization: `Bearer ${token}` },
  });
  return response.data;
};
...
export const fetchRepartoOpenNotes = async (repartoId, token) => {
  const response = await apiClient.get(`/api/attivita_commessa/reparto/${repartoId}/note-aperte`, {
    headers: { Authorization: `Bearer ${token}` },
  });
  return response.data;
};
...
export const fetchRepartoDashboard = async (repartoId, token) => {
  const response = await apiClient.get(`/api/attivita_commessa/reparto/${repartoId}/dashboard`, {
    headers: { Authorization: `Bearer ${token}` },
  });
  return response.data;
};
