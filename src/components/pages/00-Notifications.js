...
import { fetchCategorie } from '../services/API/notifiche-api';
      ...
      {isBurgerMenuOpen && (
        <div className="burger-menu-XL">
          ...
          <div className="burger-menu-content">
            ...
            <PreferenzeNotificheSection token={token} />
          </div>
        </div>
      )}
          ...
          <ul>
            {notificheFiltrate.map((notification) => (
              ...
              >
                ...
                <small>Ricevuta il: {new Date(notification.created_at).toLocaleDateString()}</small>
                <div className="row">
