...
function SchedaAssistenzaForm({ scheda, commessa, userId, editable, onClose }) {
  // ===== HOOK: REFS =====
  ...
  const filename = `Scheda assistenza commessa:${commessa}.pdf`;
  ...
  return (
    ...
    <div ref={pdfRef}>
      ...
      <div ref={schedaRef} className="flex-column-center">
        <h1>Scheda assistenza commessa: {commessa}</h1>
        {/* TESTO SOLO PER PDF */}
...
export default SchedaAssistenzaForm;
