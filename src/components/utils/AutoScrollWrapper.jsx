...
export default function AutoScrollWrapper({ children, isDragging, threshold = 300, maxSpeed = 20 }) {
  const containerRef = useRef(null);

  useAutoScroll(containerRef, isDragging, maxSpeed, threshold);

  return (
    <div ref={containerRef} className="auto-scroll-container" style={{ overflow: "auto", position: "relative" }}>
